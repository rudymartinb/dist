...
if( $post != null ){
	...
	$gru->abr = $abrgru;
	if( $gru->GrabarModi() ){
		echo "Codigo $codgru modificado con exito ";
	} else {
		echo "Codigo $codgru $desgru no pudo ser modificado";
	}
}
...
$p->body->AddHTML( '<form name="input" action="clientesgrupos_modi2.php" method="post">' );
