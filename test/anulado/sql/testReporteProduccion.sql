...
call distdev.sp_ReporteProduccionAlta(
@fecha,
1000,
50,
"",
...
set @tmp := ( ( SELECT count(*) FROM distdev.reporteproduccion1 ) ) ;
select tap.eq( @tmp, 1, " reporteproduccion1 cuenta "); 

call distdev.sp_ReporteProduccionTiradaAlta(
1,
"00:00",
"01:00",
1,
...
8 ,
@idx );
set @tmp := ( ( SELECT count(*) FROM distdev.reporteproduccion2 ) ) ;
select tap.eq( @tmp, 1, " reporteproduccion2 cuenta "); 
