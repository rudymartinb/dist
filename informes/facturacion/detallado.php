	...
	*/
	...
	foreach( $lista as $key => $value ){
      ...
      $total5 += $value['cant3'];
		$total7 += $value['ncred'];
		$p->body->DivOpen( "", "admitem" );
		$p->body->DivOpen( "col1", "col1" ); $p->body->AddHTML( "<a href='detalle_cliente.php?prod=".$prod."&cli=".md5( $value['cliage'] )."&desde=".$desde."&hasta=".$hasta."'>".$value['cliage']." ".$value['razcli']."</a>" ); $p->body->DivClose( );
